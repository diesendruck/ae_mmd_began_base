...
class Trainer(object):
    def __init__(self, config):
        ...
        self.height, self.width, self.channel = 28, 28, 3  #NOTE: New to cifar.
        self.scale_size = 28 
        self.repeat_num = int(np.log2(self.height)) - 1
    ...
    def build_classifier(self):
        ...
        self.c_images = tf.placeholder(tf.float32,
            [None, self.channel, self.scale_size, self.scale_size])
    ...
    def train(self):
        ...
        (self.c_user_images,
         self.c_user_labels,
         self.c_train_images,
         self.c_train_labels) = self.prep_data(split='train', mix='2080', n_user=100)
        (self.c_test_images,
        ...
        # Save a sample.
        imsave('samp0.png', self.c_user_images[0].transpose([1, 2, 0]))
        imsave('samp1.png', self.c_user_images[20].transpose([1, 2, 0]))
        imsave('samp2.png', self.c_user_images[1].transpose([1, 2, 0]))
