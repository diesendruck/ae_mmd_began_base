...
net_arg.add_argument('--scale_size', type=int, default=28, choices=[28, 32, 64],
...
data_arg.add_argument('--just01', type=str2bool, default=True)
...
misc_arg.add_argument('--save_step', type=int, default=1001)
